...
$json=array();
	...
	$insert = "INSERT INTO C_Publicaciones_Maestro (nombre_usuario, clave, publicacion, puesto, nombres, apellidos) VALUES ('{$usuario}','{$escuela}','{$publi}','Maestro','{$nombres}','{$apellidos}')";
